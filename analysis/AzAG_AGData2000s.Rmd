...
Census2000s[is.infinite(Census2000s)] <- 0
Census2000s <- replace(Census2000s, is.infinite(Census2000s), 0)
```
...
# calculate variable for the area of each municipality in hectares
Data2000s_poly$LUPoly_Area_ha <- as.numeric(Data2000s_poly$Area_m2)/10000
...
Data2000s_poly_rs <- Data2000s_poly_rs %>% rowwise() %>% mutate(
  ...
  PctPU_Maize_Temp = PU_Maize_Temp / Primary_PU,
  PctPU_Maize_Irrig = PU_Maize_Irrig / Primary_PU,
  ...
  PopRuralMz = ifelse(AGType == "Temporal", (Pop_Rural * PctPU_Maize_Temp), (Pop_Rural * PctPU_Maize_Irrig)),
  PrimaryMz = ifelse(AGType == "Temporal", (Primary * PctPU_Maize_Temp), (Primary * PctPU_Maize_Irrig)),
  AGWorkersMz = ifelse(AGType == "Temporal", (AG_Workers * PctPU_Maize_Temp), (AG_Workers * PctPU_Maize_Irrig)),
  TotalLaborMz = ifelse(AGType == "Temporal", (TotalLabor * PctPU_Maize_Temp), (TotalLabor * PctPU_Maize_Irrig)),
  LUTotalMz = ifelse(AGType == "Temporal", (LU_Total * PctPU_Maize_Temp), (LU_Total * PctPU_Maize_Irrig)), 
  ContractLaboTotMz = ifelse(AGType == "Temporal", (ContractLabor_Tot * PctPU_Maize_Temp), (ContractLabor_Tot * PctPU_Maize_Irrig)), 
  ContractLaborFullMz = ifelse(AGType == "Temporal", (ContractLabor_More6Mo * PctPU_Maize_Temp), (ContractLabor_More6Mo * PctPU_Maize_Irrig)), 
  ContractLaboPartMz = ifelse(AGType == "Temporal", (ContractLabor_Less6Mo * PctPU_Maize_Temp), (ContractLabor_Less6Mo * PctPU_Maize_Irrig)), 
  FamLaborMz = ifelse(AGType == "Temporal", (FamLabor_Tot * PctPU_Maize_Temp), (FamLabor_Tot * PctPU_Maize_Irrig)), 
  MechanizEquipMz = ifelse(AGType == "Temporal", (MechanizEquip * PctPU_Maize_Temp), (MechanizEquip * PctPU_Maize_Irrig)), 
  DraftAnimalsMz = ifelse(AGType == "Temporal", (DraftAnimals_Total * PctPU_Maize_Temp), (DraftAnimals_Total * PctPU_Maize_Irrig)), 
  TractorsMz = ifelse(AGType == "Temporal", (Tractors * PctPU_Maize_Temp), (Tractors * PctPU_Maize_Irrig)),
