...
```{r, label='Subset Predictors', message=FALSE,warning=FALSE}
...
```{r, label='Shortcut Import #3', message=FALSE,warning=FALSE}
...
```{r, label='Shortcut Import #4', message=FALSE,warning=FALSE}
...
```{r, label='Peripheral Cases Data Setup', message=FALSE,warning=FALSE}
...
```{r, label='Peripheral Cases Model Predictions', message=FALSE,warning=FALSE}
ArableArea_RF_model = readRDS(paste0(wd$data_p,"ArableArea_RFModel_Ranger.rda"))
