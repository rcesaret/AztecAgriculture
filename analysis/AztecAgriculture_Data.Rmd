...
packages <- c("tidyverse", "rgdal", "rgeos", "sp", "sf", "GISTools", "raster", 
              ...
              "stringi", "fuzzyjoin", "mgcv")#, "data.table", "zoo", "era", "JOPS", "mgcv","igraph",  "ggrepel","ggridges", "movecost",  "datplot", "scales",
...
BDRICM_df = Terra_df(BD_df, "BDRICM")
...
names(Soil) = c("BD", "S", "Z", "C", "SOC", "CEC", "OCD", "N", 
                "SOCS", "BDRICM", "BDRLOG", "BDTICM")
