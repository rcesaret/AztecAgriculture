...
SIAP_4 = SIAP_3 %>% 
  ...
  mutate(AvgArea_Irrig = mean(Area_Irrig[AGType == "Riego"], na.rm=T),
         sdArea_Irrig = sd(Area_Irrig[AGType == "Riego"], na.rm=T),
         cvArea_Irrig = sdArea_Irrig/AvgArea_Irrig*100,
         AvgArea_Irrig_Maize = mean(Area_Irrig_Maize[AGType == "Riego"], na.rm=T),
         sdArea_Irrig_Maize = sd(Area_Irrig_Maize[AGType == "Riego"], na.rm=T),
         cvArea_Irrig_Maize = sdArea_Irrig_Maize/AvgArea_Irrig_Maize*100,
         AvgArea_Irrig_Fodder = mean(Area_Irrig_Fodder[AGType == "Riego"], na.rm=T),
         AvgArea_Irrig_OtherCrops = mean(Area_Irrig_OtherCrops[AGType == "Riego"], na.rm=T),
         AvgPctArea_Maize_Crops_Irrig = mean(PctArea_Maize_Crops_Irrig[AGType == "Riego"], na.rm=T),
         sdPctArea_Maize_Crops_Irrig = sd(PctArea_Maize_Crops_Irrig[AGType == "Riego"], na.rm=T),
         cvPctArea_Maize_Crops_Irrig = sdPctArea_Maize_Crops_Irrig/AvgPctArea_Maize_Crops_Irrig*100,
         AvgPctArea_Maize_Irrig = mean(PctArea_Maize_Irrig[AGType == "Riego"], na.rm=T),
         sdPctArea_Maize_Irrig = sd(PctArea_Maize_Irrig[AGType == "Riego"], na.rm=T),
         cvPctArea_Maize_Irrig = sdPctArea_Maize_Irrig/AvgPctArea_Maize_Irrig*100,
         AvgArea_Temp = mean(Area_Temp[AGType == "Temporal"], na.rm=T),
         sdArea_Temp = sd(Area_Temp[AGType == "Temporal"], na.rm=T),
         cvArea_Temp = sdArea_Temp/AvgArea_Temp*100,
         AvgArea_Temp_Maize = mean(Area_Temp_Maize[AGType == "Temporal"], na.rm=T),
         sdArea_Temp_Maize = sd(Area_Temp_Maize[AGType == "Temporal"], na.rm=T),
         cvArea_Temp_Maize = sdArea_Temp_Maize/AvgArea_Temp_Maize*100,
         AvgArea_Temp_Fodder = mean(Area_Temp_Fodder[AGType == "Temporal"], na.rm=T),
         AvgArea_Temp_OtherCrops = mean(Area_Temp_OtherCrops[AGType == "Temporal"], na.rm=T),
         AvgPctArea_Maize_Crops_Temp = mean(PctArea_Maize_Crops_Temp[AGType == "Temporal"], na.rm=T),
         sdPctArea_Maize_Crops_Temp = sd(PctArea_Maize_Crops_Temp[AGType == "Temporal"], na.rm=T),
         cvPctArea_Maize_Crops_Temp = sdPctArea_Maize_Crops_Temp/AvgPctArea_Maize_Crops_Temp*100,
         AvgPctArea_Maize_Temp = mean(PctArea_Maize_Temp[AGType == "Temporal"], na.rm=T),
         sdPctArea_Maize_Temp = sd(PctArea_Maize_Temp[AGType == "Temporal"], na.rm=T),
         ...
         cvArea_Total_Maize = sdArea_AGType_Maize/AvgArea_Total_Maize*100,
         ...
         cvPctArea_Maize_Crops_Total = sdPctArea_Maize_Crops_AGType/AvgPctArea_Maize_Crops_AGType*100,
         AvgPctArea_Maize_Total = mean(PctArea_Maize_AGType, na.rm=T),
         sdPctArea_Maize_Total = sd(PctArea_Maize_AGType, na.rm=T),
         cvPctArea_Maize_Total = sdPctArea_Maize_AGType/AvgPctArea_Maize_AGType*100) %>%
  # ungroup the data
  ungroup() %>% 
...
SIAP_5 = SIAP_4 %>% 
  ...
  summarize(AvgYield = mean(Yield, na.rm=T), # mean/average maize yield
            ...
            AvgArea_Irrig = mean(AvgArea_Irrig, na.rm=T),
            sdArea_Irrig = mean(sdArea_Irrig, na.rm=T),
            cvArea_Irrig = mean(cvArea_Irrig, na.rm=T),
            AvgArea_Irrig_Maize = mean(AvgArea_Irrig_Maize, na.rm=T),
            sdArea_Irrig_Maize = mean(sdArea_Irrig_Maize, na.rm=T),
            cvArea_Irrig_Maize = mean(cvArea_Irrig_Maize, na.rm=T),
            AvgArea_Irrig_Fodder = mean(AvgArea_Irrig_Fodder, na.rm=T),
            AvgArea_Irrig_OtherCrops = mean(AvgArea_Irrig_OtherCrops, na.rm=T),
            AvgPctArea_Maize_Crops_Irrig = mean(AvgPctArea_Maize_Crops_Irrig, na.rm=T),
            sdPctArea_Maize_Crops_Irrig = mean(sdPctArea_Maize_Crops_Irrig, na.rm=T),
            cvPctArea_Maize_Crops_Irrig = mean(cvPctArea_Maize_Crops_Irrig, na.rm=T),
            AvgPctArea_Maize_Irrig = mean(AvgPctArea_Maize_Irrig, na.rm=T),
            sdPctArea_Maize_Irrig = mean(sdPctArea_Maize_Irrig, na.rm=T),
            cvPctArea_Maize_Irrig = mean(cvPctArea_Maize_Irrig, na.rm=T),
            AvgArea_Temp = mean(AvgArea_Temp, na.rm=T),
            sdArea_Temp = mean(sdArea_Temp, na.rm=T),
            cvArea_Temp = mean(cvArea_Temp, na.rm=T),
            AvgArea_Temp_Maize = mean(AvgArea_Temp_Maize, na.rm=T),
            sdArea_Temp_Maize = mean(sdArea_Temp_Maize, na.rm=T),
            cvArea_Temp_Maize = mean(cvArea_Temp_Maize, na.rm=T),
            AvgArea_Temp_Fodder = mean(AvgArea_Temp_Fodder, na.rm=T),
            AvgArea_Temp_OtherCrops = mean(AvgArea_Temp_OtherCrops, na.rm=T),
            AvgPctArea_Maize_Crops_Temp = mean(AvgPctArea_Maize_Crops_Temp, na.rm=T),
            sdPctArea_Maize_Crops_Temp = mean(sdPctArea_Maize_Crops_Temp, na.rm=T),
            cvPctArea_Maize_Crops_Temp = mean(cvPctArea_Maize_Crops_Temp, na.rm=T),
            AvgPctArea_Maize_Temp = mean(AvgPctArea_Maize_Temp, na.rm=T),
            sdPctArea_Maize_Temp = mean(sdPctArea_Maize_Temp, na.rm=T),
            cvPctArea_Maize_Temp = mean(cvPctArea_Maize_Temp, na.rm=T),
...
x = SIAP_4 %>% 
  ...
  summarize(AvgYield = mean(Yield, na.rm=T), # mean/average maize yield
            ...
            cvArea = sdArea_Total/AvgArea_Total*100, # while _Total is the average of them per year per EstadoMunicipio
            AvgArea_Maize = mean(Area_AGType_Maize, na.rm=T),
            sdArea_Maize = sd(Area_AGType_Maize, na.rm=T),
            cvArea_Maize = sdArea_AGType_Maize/AvgArea_Total_Maize*100,
            ...
            cvPctArea_Maize_Crops = sdPctArea_Maize_Crops_AGType/AvgPctArea_Maize_Crops_AGType*100,
            AvgPctArea_Maize = mean(PctArea_Maize_AGType, na.rm=T),
            sdPctArea_Maize = sd(PctArea_Maize_AGType, na.rm=T),
            cvPctArea_Maize = sdPctArea_Maize_AGType/AvgPctArea_Maize_AGType*100) %>% 
  ungroup()
...
SIAP_6 = SIAP_4 %>% 
  ...
  mutate(AGType = case_when(
    ...
    AGType == "Total" ~ "Total")) %>% 
  pivot_wider(names_from = c(Variable, AGType), names_glue = "{Variable}_{AGType}", values_from = Value) %>% 
  mutate(
...
Dens.df = rbind(EarlyColonial_dens2, LateColonial_dens2, SandersAztec_dens2, AGCensus1960_T_dens2, AGCensus1960_A_dens2, SandersC20_dens2, AGCensus1991_dens2, SIAP_4_2003_dens2, SIAP_4_2003a_dens2, AGCensus2007_dens2, SIAP_4_2020_dens2, SIAP_4_2020a_dens2, SIAP_4_Avg_dens2, SIAP_4_Avg_T_dens2)

CY_prob_dens_list <- list(EarlyColonial_dens, LateColonial_dens, SandersAztec_dens, AGCensus1960_T_dens, AGCensus1960_A_dens, AGCensus1960_L_dens, AGCensus1960_S_dens, AGCensus1960_E_dens, AGCensus1960_BOM_A_dens, AGCensus1960_BOM_T_dens, AGCensus1960_BOM_L_dens, AGCensus1960_BOM_S_dens, AGCensus1960_BOM_E_dens, SandersC20_dens, AGCensus1991_dens, SIAP_4_2003_dens, SIAP_4_2003a_dens, AGCensus2007_dens, SIAP_4_2020_dens, SIAP_4_2020a_dens, SIAP_4_Avg_dens, SIAP_4_Avg_T_dens)
names(CY_prob_dens_list) <- c("EarlyColonial_dens", "LateColonial_dens", "SandersAztec_dens", "AGCensus1960_T_dens", "AGCensus1960_A_dens", "AGCensus1960_L_dens", "AGCensus1960_S_dens", "AGCensus1960_E_dens", "AGCensus1960_BOM_A_dens", "AGCensus1960_BOM_T_dens", "AGCensus1960_BOM_L_dens", "AGCensus1960_BOM_S_dens", "AGCensus1960_BOM_E_dens", "SandersC20_dens", "AGCensus1991_dens", "SIAP_4_2003_dens", "SIAP_4_2003a_dens", "AGCensus2007_dens", "SIAP_4_2020_dens", "SIAP_4_2020a_dens", "SIAP_4_Avg_dens", "SIAP_4_Avg_T_dens")

CY_df_list <- list(EarlyColonial, LateColonial, AGCensus1960_A, AGCensus1960_T, AGCensus1960_S, AGCensus1960_L, AGCensus1960_E, AGCensus1960_BOM_A, AGCensus1960_BOM_T, AGCensus1960_BOM_L, AGCensus1960_BOM_S, AGCensus1960_BOM_E, AGCensus1991_T, AGCensus2007_T, SIAP_4_2003, SIAP_4_2003a, SIAP_4_2020, SIAP_4_2020a, SIAP_4_Avg, SIAP_4_Avg_T)
names(CY_df_list) <- c("EarlyColonial", "LateColonial", "AGCensus1960_A", "AGCensus1960_T", "AGCensus1960_S", "AGCensus1960_L", "AGCensus1960_E", "AGCensus1960_BOM_A", "AGCensus1960_BOM_T", "AGCensus1960_BOM_L", "AGCensus1960_BOM_S", "AGCensus1960_BOM_E", "AGCensus1991_T", "AGCensus2007_T", "SIAP_4_2003", "SIAP_4_2003a", "SIAP_4_2020", "SIAP_4_2020a", "SIAP_4_Avg", "SIAP_4_Avg_T")

CY_data_list <- list(Colonial, AGCensus1960, AGCensus1991, AGCensus2007, SandersAztec, SandersC20)
names(CY_data_list) <- c("Colonial", "AGCensus1960", "AGCensus1991", "AGCensus2007", "SandersAztec", "SandersC20")

rm(EarlyColonial_dens2, LateColonial_dens2, SandersAztec_dens2, AGCensus1960_T_dens2, AGCensus1960_A_dens2, SandersC20_dens2, AGCensus1991_dens2, SIAP_4_2003_dens2, SIAP_4_2003a_dens2, AGCensus2007_dens2, SIAP_4_2020_dens2, SIAP_4_2020a_dens2, SIAP_4_Avg_dens2, SIAP_4_Avg_T_dens2, s, nnn, EarlyColonial_dens, LateColonial_dens, SandersAztec_dens, AGCensus1960_T_dens, AGCensus1960_A_dens, AGCensus1960_L_dens, AGCensus1960_S_dens, AGCensus1960_E_dens, AGCensus1960_BOM_A_dens, AGCensus1960_BOM_T_dens, AGCensus1960_BOM_L_dens, AGCensus1960_BOM_S_dens, AGCensus1960_BOM_E_dens, SandersC20_dens, AGCensus1991_dens, SIAP_4_2003_dens, SIAP_4_2003a_dens, AGCensus2007_dens, SIAP_4_2020_dens, SIAP_4_2020a_dens, SIAP_4_Avg_dens, SIAP_4_Avg_T_dens,EarlyColonial, LateColonial, AGCensus1960_A, AGCensus1960_T, AGCensus1960_S, AGCensus1960_L, AGCensus1960_E, AGCensus1960_BOM_A, AGCensus1960_BOM_T, AGCensus1960_BOM_L, AGCensus1960_BOM_S, AGCensus1960_BOM_E, AGCensus1991_T, AGCensus2007_T, SIAP_4_2003, SIAP_4_2003a, SIAP_4_2020, SIAP_4_2020a, SIAP_4_Avg, SIAP_4_Avg_T, Colonial, AGCensus1960, AGCensus1991, AGCensus2007, SandersAztec, SandersC20)
```
...
AGC1960 = CY_data_list[["AGCensus1960"]] %>% filter(INCLUDE == TRUE) %>% 
  ...
  rowwise() %>% mutate(Y_1960_Max = max(Y_1960_E, Y_1960_S, Y_1960_L, Y_1960_Total, na.rm=T)) %>% ungrou()
...
var = c("Y_1960_Total", "Y_1960_E", "Y_1960_L", "Y_1960_S", "Y_1991_Total", "Y_AGC2007_Total", "AvgYield_Total", "AvgYield_Irrig", "AvgYield_Temp")
tit = c("Central Mexico Study Region - 1960 Agricultural Census", "Central Mexico Study Region - 1960 Agricultural Census", "Central Mexico Study Region - 1960 Agricultural Census", "Central Mexico Study Region - 1960 Agricultural Census", "Central Mexico Study Region - 1991 Agricultural Census", "Central Mexico Study Region - 2007 Agricultural Census", "Central Mexico Study Region - SIAP 2003-2021", "Central Mexico Study Region - SIAP 2003-2021", "Central Mexico Study Region - SIAP 2003-2021")
subtit = c("Z-Score Average Overall Maize Yield", "Z-Score Average Ejido Maize Yield", "Z-Score Average Large Farm Maize Yield", "Z-Score Average Small Farm Maize Yield", "Z-Score Average Overall Maize Yield", "Z-Score Average Overall Maize Yield", "Z-Score Average Overall Maize Yield", "Z-Score Average Irrigation Maize Yield", "Z-Score Average Temporal Maize Yield")
name=c("Y_1960_Total", "Y_1960_E", "Y_1960_L", "Y_1960_S", "Y_1991_Total", "Y_AGC2007_Total", "SIAP_AvgYield_Total", "SIAP_AvgYield_Irrig", "SIAP_AvgYield_Temp")
