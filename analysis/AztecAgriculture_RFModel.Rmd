...
### BOM Chinampas
"Valle de Chalco Solidaridad, Mexico", "Milpa Alta, Distrito Federal", "Tlahuac, Distrito Federal", "Xochimilco, Distrito Federal",
```{r}
...
writeRaster(Clim_sub, filename = paste0(wd$data_p, "AvgYield_PredictRast2.tif"), overwrite=TRUE)
