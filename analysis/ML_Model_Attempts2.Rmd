...
Data_sf_set3_train = as_task_regr_st(Data_sf_set1, target = "AvgYield", id = "Data_sf_set3_train")
Data_sf_set3_test = as_task_regr_st(Data_sf_set1, target = "AvgYield", id = "Data_sf_set3_test")
Data_sf_set3_train = Data_sf_set3_train$filter(splits$train)
Data_sf_set3_test = Data_sf_set3_test$filter(splits$test)
...
generalization = as.numeric(RegRF_tuned$train(Data_sf_set3_train)$predict(Data_sf_set3_test)$score(msr("regr.rsq")))

# results output dataframe
a <- data.frame(FeatSelect = c(1.0),n_Features = as.numeric(length(Data_sf_set3_tsk$feature_names)),Perform_General = generalization, Perform_Outsample = outsample)
...
temp_task = as_task_regr_st(Data_sf_set1, target = "AvgYield", id = "Data_sf_set3_train")
rfecv = fselect(
...
Data_sf_set3_rfecv_0.9$select(rfecv$result_feature_set)
  ...
  temp_task = as_task_regr_st(Data_sf_set1, target = "AvgYield", id = "temp_task")
  temp_task$select(rr$learners[[1]]$state$model$fselect_instance$result_feature_set)
  temp_train = as_task_regr_st(Data_sf_set1, target = "AvgYield", id = "temp_train")
  temp_train$select(rr$learners[[1]]$state$model$fselect_instance$result_feature_set)
  temp_train = temp_train$filter(splits$train)
  temp_test = as_task_regr_st(Data_sf_set1, target = "AvgYield", id = "temp_test")
