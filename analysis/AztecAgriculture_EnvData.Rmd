...
HTTP <- "https://os.zhdk.cloud.switch.ch/envicloud/chelsa/chelsa_V2/GLOBAL/climatologies/1981-2010/"
...
for (i in 1:length(var)) {
    ...
    temp <- paste0(HTTP, var[i], "/CHELSA_", var2[i], "_1981-2010_V.2.1.tif")
    URLs <- c(URLs, temp)
...
for (i in 1:length(URLs)){#
  ...
  destination <- paste0("D:/Dropbox (ASU)/AztecAgricultureModel/GIS_Data/CHELSA/", files[i])
  download.file(source_url, destination, mode="wb")
}

rm(source_url, destination, URLs, files, temp, var, var2, month, HTTP, URLs)
