...
Topo_r_30m <- (c(DEM, slope, Accum_fd8, TRI, TWI, STI, SPI, flood_order, valleys_lq, elev_watershed, curv_vert_excess, curv_horiz_excess, wbt_minimal_curvature, wbt_maximal_curvature, wbt_mean_curvature))

nam = c("DEM", "Slope", "Accum_fd8", "TRI", "TWI", "STI", "SPI", "flood_order", "valleys_lq", "elev_watershed", "curv_vert_excess", "curv_horiz_excess", "wbt_minimal_curvature", "wbt_maximal_curvature", "wbt_mean_curvature")

names(Topo_r_30m) = nam

rm(slope, Accum, Accum_fd8, TRI, TWI, STI, SPI, flood_order, valleys_lq, elev_watershed, curv_vert_excess, curv_horiz_excess, wbt_minimal_curvature, wbt_maximal_curvature, wbt_mean_curvature, nam)
...
r.grow.distance
--buffer land use by -45?
--mod land use by streams
--mod land use by elevation???
...
fLU = freq(CONABIO_2015_LandUse_30m, usenames=T, zones=SIAP_2015_Fields, wide=T)
...
fgeo = freq(Geomorphons, usenames=T, zones=SIAP_2015_Fields, wide=T)
...
z1 = zonal(c(Topo_r_30m, Soil_30m), SIAP_2015_Fields, fun="mean", na.rm=T)
z1$stat = "Mean"
z2 = zonal(c(Topo_r_30m, Soil_30m), SIAP_2015_Fields, fun="min", na.rm=T)
z2$stat = "Min"
z3 = zonal(c(Topo_r_30m, Soil_30m), SIAP_2015_Fields, fun="max", na.rm=T)
z3$stat = "Max"
...
raster_dropped <- drop(x, layers = c("SIAP_2015_Fields_f", "CONABIO_2015_LandUse_30m", "Geomorphons"))
...
Arable_RF_df <- Arable_RF_df %>% 
  mutate(SIAP_2015_Fields_f = factor(SIAP_2015_Fields_f, levels = c("Uncultivated", "Cultivated"))) %>%
  rename(Cultivated = SIAP_2015_Fields_f)

#Hist_DEM <- 
Arable_RF_df %>% ggplot() +
geom_histogram(aes(x = DEM, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
...
#Hist_Slope <- 
Arable_RF_df %>% ggplot() +
geom_histogram(aes(x = Slope, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
  scale_fill_manual(values = c("indianred1", "green"), guide = "none")+
  scale_color_manual(values = c("firebrick1", "green4"), guide = "none")+
...
#Hist_TRI <- 
Arable_RF_df %>% ggplot() +
geom_histogram(aes(x = TRI, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
  scale_fill_manual(values = c("indianred1", "green"), guide = "none")+
  scale_color_manual(values = c("firebrick1", "green4"), guide = "none")+
...
#Hist_TWI <- 
Arable_RF_df %>% ggplot() +
geom_histogram(aes(x = TWI, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
  scale_fill_manual(values = c("indianred1", "green"), guide = "none")+
  scale_color_manual(values = c("firebrick1", "green4"), guide = "none")+
...
geom_histogram(aes(x = STI, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
  scale_fill_manual(values = c("indianred1", "green"), guide = "none")+
  scale_color_manual(values = c("firebrick1", "green4"), guide = "none")+
...
geom_histogram(aes(x = SPI, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
  scale_fill_manual(values = c("indianred1", "green"), guide = "none")+
  scale_color_manual(values = c("firebrick1", "green4"), guide = "none")+
...
#Hist_BDRICM <- 
Arable_RF_df %>% ggplot() +
geom_histogram(aes(x = BDRICM, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
  scale_fill_manual(values = c("indianred1", "green"), guide = "none")+
  scale_color_manual(values = c("firebrick1", "green4"), guide = "none")+
  labs(x ="Depth to bedrock up to 200cm (BDRICM)", y = "Count") + theme_classic()

Arable_RF_df %>% ggplot() +
geom_histogram(aes(x = BDRLOG, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
  scale_fill_manual(values = c("indianred1", "green"), guide = "none")+
  scale_color_manual(values = c("firebrick1", "green4"), guide = "none")+
...
Arable_RF_df %>% ggplot() +
geom_histogram(aes(x = BDTICM, color = Cultivated, fill = Cultivated), alpha = 0.4, position = "identity") +
  scale_fill_manual(values = c("indianred1", "green"), guide = "none")+
  scale_color_manual(values = c("firebrick1", "green4"), guide = "none")+
...
Arable_RF_df <- Arable_RF_df %>% 
  mutate(Problem = FALSE,
         Cultiv_3100masl = ifelse(Cultivated == "Cultivated" & DEM >= 3100, TRUE, FALSE),
         Problem = ifelse(Cultivated == "Cultivated" & LandUse == "Water", TRUE, Problem),
         Problem = ifelse(Cultivated == "Cultivated" & LandUse == "Wetland", TRUE, Problem),
         Problem = ifelse(Cultivated == "Cultivated" & LandUse == "Settlement", TRUE, Problem),
         Problem_3100masl = ifelse(Cultivated == "Cultivated" & DEM >= 3100, TRUE, Problem),
         
         Inarable1_wt = 0,
         Inarable1_wt = ifelse(Cultivated == "Uncultivated" & DEM >= 3100, (Inarable1_wt+1), Inarable1_wt),
         Inarable1_wt = ifelse(Cultivated == "Uncultivated" & LandUse == "Water", (Inarable1_wt+1), Inarable1_wt),
         Inarable1_wt = ifelse(Cultivated == "Uncultivated" & LandUse == "Wetland", (Inarable1_wt+1), Inarable1_wt),
         Inarable1_wt = ifelse(Cultivated == "Uncultivated" & LandUse == "Settlement", (Inarable1_wt+1), Inarable1_wt),
         Inarable1_wt = ifelse(Cultivated == "Uncultivated" & LandUse == "Glacial", (Inarable1_wt+1), Inarable1_wt),
         Inarable1 = ifelse(Inarable1_wt > 0, TRUE, FALSE),
         
         Inarable_3100masl = ifelse(Cultivated == "Uncultivated" & DEM >= 3100, TRUE, FALSE),
         Inarable_water = ifelse(Cultivated == "Uncultivated" & LandUse == "Water", TRUE, FALSE),
         Inarable_wetland = ifelse(Cultivated == "Uncultivated" & LandUse == "Wetland", TRUE, FALSE),
         Inarable_settlement = ifelse(Cultivated == "Uncultivated" & LandUse == "Settlement", TRUE, FALSE),
         Inarable_glacial = ifelse(Cultivated == "Uncultivated" & LandUse == "Glacial", TRUE, FALSE),
         
         Inarable2_wt = 0,
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & DEM >= 2850 & DEM < 3100, (Inarable2_wt+1), Inarable2_wt),
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & Slope > 15, (Inarable2_wt+1), Inarable2_wt),
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & BDRLOG > 70, (Inarable2_wt+1), Inarable2_wt),
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & BDRICM < 40.79, (Inarable2_wt+1), Inarable2_wt),
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & BDTICM <= 3.36, (Inarable2_wt+1), Inarable2_wt),
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & STI > 15, (Inarable2_wt+1), Inarable2_wt),
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & TRI > 15, (Inarable2_wt+1), Inarable2_wt),
         #Inarable2_wt = ifelse(Cultivated == "Uncultivated" & SOC > XXX, (Inarable2_wt+1), Inarable2_wt),
         #Inarable2_wt = ifelse(Cultivated == "Uncultivated" & BD > XXX, (Inarable2_wt+1), Inarable2_wt),
         #Inarable2_wt = ifelse(Cultivated == "Uncultivated" & OCD > XXX, (Inarable2_wt+1), Inarable2_wt),
         #Inarable2_wt = ifelse(Cultivated == "Uncultivated" & N > XXX, (Inarable2_wt+1), Inarable2_wt),
         #Inarable2_wt = ifelse(Cultivated == "Uncultivated" & SOCS > XXX, (Inarable2_wt+1), Inarable2_wt),
         
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & Geomorphons == "Summit", (Inarable2_wt+1), Inarable2_wt),
         Inarable2_wt = ifelse(Cultivated == "Uncultivated" & Geomorphons == "Depression", (Inarable2_wt+1), Inarable2_wt),
         Inarable2 = ifelse(Inarable2_wt > 0, TRUE, FALSE),
         
         Arable = ifelse(Cultivated == "Cultivated" & Problem == FALSE, TRUE, FALSE),
         Arable_wt = ifelse(Cultivated == "Cultivated" & Problem == FALSE, 1, 0),
...
TrainSample = Arable_RF_df %>% group_by(Stratum) %>%
  slice_sample(n = SampSize[1], prop, by = NULL, weight_by = wt, replace = FALSE)

write_csv(TrainSample, paste0(wd$data_p,"ArableArea_RFModel_TrainData.csv.gz"))
TrainSample <- read_csv(paste0(wd$data_p,"ArableArea_RFModel_TrainData.csv.gz"))

tt = TrainSample %>% select(Cells) %>% mutate(TraningSample = TRUE)
