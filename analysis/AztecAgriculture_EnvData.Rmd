...
Arable_RF_df <- Arable_RF_df %>% mutate(zone = case_when(
    Cultiv == 1 ~ "Uncultivated",
    Cultiv == 2 ~ "Cultivated"))

#zzz = Arable_RF_df[1:100000,]
zzz <- zzz %>% mutate(Cultiv = ifelse(Cultiv == "Cultivated" & LandUseArchy == "Settlement", "Uncultivated", Cultiv))
```{r}
