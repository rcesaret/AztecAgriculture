...
packages <- c("tidyverse", "rgdal", "rgeos", "sp", "sf", "GISTools", "raster", 
              ...
              "geoknife", "rnoaa", "ncdf4", "gdalUtils", "zoo")
...
pdsi_ts_JunAug <- subset(pdsi_ts, which(substr(time(pdsi_ts), 6, 7) %in% c("06", "07", "08") & as.integer(substr(time(raster_stack), 1, 4)) >= 2003))

# Calculate the average of June-August for each year
pdsi_ts_JunAug_Avg <- apply(pdsi_ts_Jun_Aug, 'year', mean)
