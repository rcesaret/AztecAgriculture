...
```{r}
Data_sf = Data_sf %>% select(AvgYield, AGType, AvgPctArea_ofTotal, TotalLabor_DensArable, Fertilizer, mean.DEM:mean.rsds_fall)
...
```{r}
Data_sf_set1 = Data_sf %>% select(AvgYield, AGType, AvgPctArea_ofTotal, TotalLabor_DensArable, Fertilizer, mean.DEM, mean.Slope, mean.Accum, mean.TWI, mean.STI, mean.DistStreams, mean.ElevAboveStreams, mean.elev_watershed, mean.FloodOrder_Rel, mean.BDRICM, mean.AWCtS_2m, mean.S, mean.Z, mean.CF, mean.CEC, mean.OCD, mean.N, mean.swb, mean.gdd10, mean.cmi_april, mean.cmi_may,mean.pr_june, mean.cmi_summer78, mean.pr_sept, mean.cmi_oct, mean.pet_april, mean.rsds_may, mean.pet_june, mean.rsds_summer78, mean.pet_sept, mean.pet_oct)
...
Data_sf_set2 = Data_sf %>% select(AvgYield, AGType, AvgPctArea_ofTotal, TotalLabor_DensArable, Fertilizer, mean.DEM, mean.Slope_sqrt, mean.Accum, mean.TWI, mean.STI, mean.DistStreams, mean.ElevAboveStreams2, mean.elev_watershed, mean.FloodOrder_Rel, mean.BDTICM, mean.AWCtS_2m, mean.C, mean.Z, mean.CF, mean.CEC, mean.OCD, mean.N, mean.swb, mean.gdd10, mean.cmi_april, mean.cmi_may,mean.pr_june, mean.cmi_summer78, mean.pr_sept, mean.cmi_oct, mean.pet_april, mean.rsds_may, mean.pet_june, mean.rsds_summer78, mean.pet_sept, mean.pet_oct)
...
Data_sf_set3 = Data_sf %>% select(AvgYield, AGType, AvgPctArea_ofTotal, TotalLabor_DensArable, Fertilizer, mean.DEM, mean.Slope_sqrt, mean.Slope, mean.Accum, mean.TWI, mean.STI, mean.DistStreams, mean.ElevAboveStreams, mean.ElevAboveStreams2, mean.elev_watershed, mean.FloodOrder_Rel, mean.BDRICM, mean.BDTICM, mean.AWCtS_2m, mean.AWCtS, mean.S, mean.Z, mean.C, mean.CF, mean.CEC, mean.OCD, mean.N, mean.swb, mean.gdd10, mean.cmi_april, mean.cmi_may,mean.pr_june, mean.cmi_summer78, mean.pr_sept, mean.cmi_oct, mean.pet_april, mean.rsds_may, mean.pet_june, mean.rsds_summer78, mean.pet_sept, mean.pet_oct)
Data_sf_set3_tsk = as_task_regr_st(Data_sf_set3, target = "AvgYield", id = "Data_sf_set3")
```
Data_df_set1_tsk, Data_df_set2_tsk
Data_sf_set1_tsk, Data_sf_set2_tsk
```{r}
...
# Setup Ranger Random Forest Regression Model (= "Learner") for tuning the hyperparameters
RegRF_Reg = lrn("regr.ranger", splitrule = "extratrees", importance = "permutation",
